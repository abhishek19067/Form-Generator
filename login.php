  ...
  <div class="container mt-3">
    ...
    <form action="logins.php" method="post">
        <div class="mb-3">
            ...
            <input type="email" class="form-control lbl" id="mail" name="mail" aria-describedby="mail" required>
        </div>
        <div class="mb-3">
        ...
        <button type="button" class="btn btn-white btns"><a href="signuppage.php" class="btnss">Sign up</a></button>
    </form>
  </div>
  <script>
