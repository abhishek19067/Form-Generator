...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_selected'])) {
    if (!empty($_POST['selected_staff'])) {
        $ids = implode(',', array_map('intval', $_POST['selected_staff']));
        $delete_sql = "DELETE FROM staff WHERE id IN ($ids)";
...
<h1 style="text-align:center;font-size:70px;font-family: 'Bodoni Moda SC, serif';font-optical-sizing: auto;font-weight: 500;font-style:normal;">Staff Information Table</h1>
...
<form method="post" action="">
    ...
    <button class="btn btn-success mt-3 mb-3">
        <a href="staff.php" style="color:white;text-decoration:none;"><i class="bi bi-plus-circle"></i> Add</a>
    </button>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            foreach($results as $row) {
                echo "<tr>"; 
                echo "<td><input type='checkbox' name='selected_staff[]' value='".$row['id']."'></td>";
                echo "<td>".$row['id']."</td>";
                ...
                <td>
                    <a href="edit_staff.php?id=<?php echo $row['id']; ?>" style="color:black;text-decoration:none;">
                        <i class="bi bi-pencil"></i> Edit
                    </a>
                </td>
                <td>
                    <a href="delete_staff.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')" style="color:black;text-decoration:none;">
