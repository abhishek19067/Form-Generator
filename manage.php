...
$user_id = $_SESSION['id'];
try {
    $stmt = $conn->prepare("SELECT * FROM student_info WHERE user_id = :user_id");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_selected'])) {
    if (!empty($_POST['selected_students'])) {
        ...
        $delete_sql = "DELETE FROM student_info WHERE id IN ($ids)";
...
<h1 style="text-align:center; font-size:70px; font-family: 'Bodoni Moda SC, serif'; font-optical-sizing: auto; font-weight: 500; font-style:normal;">Student Information Table</h1>

<form method="post" action="">
    <button type="submit" name="delete_selected" class="btn btn-danger mt-3 mb-3" onclick="return confirm('Are you sure you want to delete selected students?');">Delete Selected</button>
    <button class="btn btn-success mt-3 mb-3">
        <a href="student_info.php" style="color:white;text-decoration:none;">
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_student.php?id=<?php echo $row['id']; ?>" style="color:black;text-decoration:none;">
                        <i class="bi bi-pencil"></i> Edit
                    </a>
                </td>
                <td>
                    <a href="delete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')" style="color:black;text-decoration:none;">
